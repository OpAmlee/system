...
# Build environment
grub_target_cc='gcc'
grub_target_cc_version='gcc (GCC) 12.1.0'
...
grub_target_cppflags=' -Wall -W  -DGRUB_MACHINE_EFI=1 -DGRUB_MACHINE=X86_64_EFI -m64 -nostdinc -isystem /usr/lib/gcc/x86_64-pc-linux-gnu/12.1.0/include -I$(top_srcdir)/include -I$(top_builddir)/include'
...
grub_package_version="2:2.06.r261.g2f4430cc0-1"
